...
public static class VariableExtensions
{
	private sealed class FieldCache
	{
		...
		public abstract class VariableCache
		{
			...
			public abstract object GetVariable(IIncludeVariableExtensions obj);

			public abstract void SetVariable(IIncludeVariableExtensions obj, object value);
		}
		...
		private sealed class FieldInfoCache : VariableCache
		{
			...
			public override object GetVariable(IIncludeVariableExtensions obj)
			{
				return fieldInfo.GetValue(obj);
			}

			public override void SetVariable(IIncludeVariableExtensions obj, object value)
			{
		...
		public object GetVariable(IIncludeVariableExtensions obj, string fieldName, Type expectedType)
		{
		...
		public void SetVariable(IIncludeVariableExtensions obj, string fieldName, object value, Type expectedType)
		{
			Type type = obj.GetType();
			VariableCache variableCache = GetVariableCache(type, fieldName);
			if (variableCache.IsCorrectType(expectedType))
			{
				...
				obj.OnUpdatedVariable(fieldName);
			}
		}

		public bool VariableExists(Type objType, string fieldName, Type expectedType)
		{
			if (GetVariableCache(objType, fieldName).IsCorrectType(expectedType))
			{
				return true;
			}
			return false;
	...
	public static void SetVariable<T>(this IIncludeVariableExtensions obj, string fieldName, T value)
	{
		obj.SetVariable(fieldName, value, typeof(T));
	}

	public static T GetVariable<T>(this IIncludeVariableExtensions obj, string fieldName)
	{
	...
	public static List<T> GetVariables<T>(this IIncludeVariableExtensions obj, string fieldNameContains)
	{
	...
	public static List<T> GetVariables<T>(this IIncludeVariableExtensions obj, Func<string, bool> predicate)
	{
		Type type = obj.GetType();
	...
	public static void SetVariable(this IIncludeVariableExtensions obj, string fieldName, object value, Type type)
	{
		variableCache.SetVariable(obj, fieldName, value, type);
	}

	public static object GetVariable(this IIncludeVariableExtensions obj, string fieldName, Type type)
	{
		return variableCache.GetVariable(obj, fieldName, type);
	}

	public static bool VariableExists<TVar, TContainer>(string fieldName) where TContainer : IIncludeVariableExtensions
	{
		return VariableExists<TContainer>(fieldName, typeof(TVar));
	}

	public static bool VariableExists<TContainer>(string fieldName, Type type) where TContainer : IIncludeVariableExtensions
	{
